...
Analysis and figure-generation code for *Updated neural representations predict
reinterpretation of ambiguous social scenes independent of gaze-linked visual resampling*.
...
Everything except `001` starts from a single shipped file:
...
### `01_condition_differences/` — condition differences
...
### `02_reinterpretation/` — reinterpretation
...
- Fig. 2 overview — `01_condition_differences/001` and `003`
- Fig. 2A — `01_condition_differences/002`
- Fig. 2C — `03_eyetracking/007._..._condition_differences.Rmd`
- Fig. 3A — `02_reinterpretation/004`
- Fig. 3B — `02_reinterpretation/00`
- Fig. 3 — `02_reinterpretation/006`
- Fig. 3E — `03_eyetracking/008._..._reinterpretation_neural.Rmd`
- Fig. 4D — `03_eyetracking/008._..._reinterpretation_neural.Rmd`

---

### raw MRI data will be added upon publication to OpenNeuro. Modifications will be made with the review process. Reach out to Clara at csava@dartmouth.edu if you have any questions. 
